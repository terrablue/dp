...
import { shebangPattern }from "../shared/ast-utils.mjs";
import { directivesPattern } from "../shared/directives.mjs";
import { Legacy } from "@eslint/eslintrc/universal";
const { ConfigOps, ConfigValidator, environments: BuiltInEnvironments } = Legacy;
import Traverser from "../shared/traverser.mjs";
import { SourceCode } from "../source-code/index.mjs";
import CodePathAnalyzer from "./code-path-analysis/code-path-analyzer.mjs";
import applyDisableDirectives from "./apply-disable-directives.mjs";
import ConfigCommentParser from "./config-comment-parser.mjs";
import NodeEventGenerator from "./node-event-generator.mjs";
import createReportTranslator from "./report-translator.mjs";
import Rules from "../rules/index.mjs";
import createEmitter from "./safe-emitter.mjs";
import SourceCodeFixer from "./source-code-fixer.mjs";
import timing from "./timing.mjs";
import ruleReplacements from "../../conf/replacements.json" assert { type : "json" }
import { getRuleFromConfig } from "../config/flat-config-helpers.mjs";
import { FlatConfigArray } from "../config/flat-config-array.mjs";
import { RuleValidator } from "../config/rule-validator.mjs";
import { assertIsRuleOptions, assertIsRuleSeverity } from "../config/flat-config-schema.mjs";
import { normalizeSeverityToString } from "../shared/severity.mjs";

const debug = _debug("eslint:linter");
...
function parse(text, languageOptions, filePath) {
    const textToParse = stripUnicodeBOM(text).replace(shebangPattern, (match, captured) => `//${captured}`);
 ...
 */
const getLinterInternalSlots = instance => internalSlotsMap.get(instance);
