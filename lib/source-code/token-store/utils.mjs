 ...
 */
const search = function search(tokens, location) {
 ...
 */
const getFirstIndex = function getFirstIndex(tokens, indexMap, startLoc) {
 ...
 * @returns {number} The index.
 */
const getLastIndex = function getLastIndex(tokens, indexMap, endLoc) {
...
export { search, getFirstIndex, getLastIndex };
