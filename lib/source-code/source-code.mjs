...
import TokenStore from "./token-store/index.mjs";
import { shebangPattern, createGlobalLinebreakMatcher } from "../shared/ast-utils.mjs";
...
import ConfigCommentParser from "../linter/config-comment-parser.mjs"
...
class SourceCode extends TokenStore {
    ...
    constructor(textOrConfig, astIfNoConfig) {
        ...
        const shebangMatched = this.text.match(shebangPattern);
    ...
    static splitLines(text) {
        return text.split(createGlobalLinebreakMatcher());
    }
