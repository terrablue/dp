...
const { canTokensBeAdjacent } = astUtils;
import { CALL, CONSTRUCT, ReferenceTracker, findVariable } from "@eslint-community/eslint-utils";
import { RegExpValidator, visitRegExpAST, RegExpParser } from "@eslint-community/regexpp";
import { REGEXPP_LATEST_ECMA_VERSION } from "./utils/regular-expressions.mjs";
