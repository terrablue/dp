...
import { CALL, CONSTRUCT, ReferenceTracker, getStringIfConstant } 
  from "@eslint-community/eslint-utils";
import { RegExpParser, visitRegExpAST } 
  from "@eslint-community/regexpp";
import { isCombiningCharacter, isEmojiModifier, isRegionalIndicatorSymbol, 
  isSurrogatePair } from "./utils/unicode/index.mjs";
import astUtils from "./utils/ast-utils.mjs";
import { isValidWithUnicodeFlag } from "./utils/regular-expressions.mjs";
