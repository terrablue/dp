...
const { version } = pkg;
import { Linter } from "../linter/index.mjs";
...
import {
    ...
    processOptions
} from  "./eslint-helpers.mjs";
import { pathToFileURL } from "url";
import { FlatConfigArray } from "../config/flat-config-array.mjs";
import LintResultCache from "../cli-engine/lint-result-cache.mjs";
...
const debug = _debug("eslint:eslint");
    ...
    async loadFormatter(name = "stylish") {
        ...
        if (!namespace && normalizedFormatName.includes("/")) {
            ...
            try {
                ...
                formatterPath = path.resolve(dirname, "../", "cli-engine", "formatters", `${normalizedFormatName}.mjs`);
            }
        }
...
export { ESLint, shouldUseFlatConfig };
